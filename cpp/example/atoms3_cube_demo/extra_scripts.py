"""
PlatformIO extra script for the AtomS3 cube demo.
...
Also adds the demo's own include/ directory for mpu6886.hpp.
"""
...
demo_inc          = rel("include")

# ---- Include paths ----------------------------------------------------------
env.Append(CPPPATH=[platform_decl_inc, lib_inc, demo_inc])
